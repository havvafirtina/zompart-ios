...
enum Localized {
    ...
    enum Scan: String, LocalizableContent, CaseIterable {
        ...
        case mismatchTitle = "scan.mismatch.title"
        case mismatchSubtitle = "scan.mismatch.subtitle"
        case mismatchFitOption = "scan.mismatch.fitOption"
        case mismatchContinueOption = "scan.mismatch.continueOption"
    ...
    enum History: String, LocalizableContent, CaseIterable {
        ...
        case empty = "history.empty"
        case detailTitle = "history.detail.title"
        case status = "history.detail.status"
        case inputText = "history.detail.inputText"
